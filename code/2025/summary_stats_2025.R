...
all_species <- rbind(n2025,m2025,a2025)
summary(all_species)
...
is.factor(all_species$AI)
all_species$AI <- as.factor(all_species$AI)
is.factor(all_species$AI)
...
trap_sum$total_captured_by_trap <- rowSums(trap_sum[, c("NOPI","MALL","AGWT")])

###save trap sum table
write.csv(trap_sum, "output/2025/trap_sum.csv")
...
ggsave("output/2025/trap_site_hist.jpg", width = 7, height = 5, units = "in", dpi = 600)  
...
##before running this code make sure you have recaps data after running the script 'bbl_kgun_recaps_20250829.R'
...
##Read in excel file
nopi_years <- read_excel("data/2025/nopi_numbers_2025.xlsx") #read in nopi file
...
ggsave("output/2025/nopi_table_2025.jpg", width = 6.5, height = 3.25, units = "in", dpi = 300)


###Time for mallards
##Read in excel file
mall_years <- read_excel("data/2025/mall_numbers_2025.xlsx") #read in mall file
...
ggsave("output/2025/mall_table_2025.jpg", width = 6.5, height = 3.25, units = "in", dpi = 300)


###Time for american green-winged teals
##Read in excel file
agwt_years <- read_excel("data/2025/agwt_numbers_2025.xlsx") #read in agwt file
...
ggsave("output/2025/agwt_table_2025.jpg", width = 6.5, height = 3.25, units = "in", dpi = 300)


###Include the Bethel banding data
bethel_ducks <- read_excel("data/2025/BETHEL_Banding_Data_Upload.xlsx")
